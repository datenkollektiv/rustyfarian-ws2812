...
Root cause analysis (recorded in [`docs/key-insights.md`](../key-insights.md) under "AVR WS2812 Driver: SPI Prerendered Encoding Limitation"):
...
5. ✅ **Lore entry resolved** in [`docs/key-insights.md`](../key-insights.md).

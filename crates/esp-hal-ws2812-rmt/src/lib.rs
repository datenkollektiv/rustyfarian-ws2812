...
//! It is the `no_std` counterpart to `esp-idf-ws2812-rmt`.
//!
...
//!
//! ```ignore
//! use esp_hal_ws2812_rmt::Ws2812Rmt;
//! use rgb::RGB8;
//!
...
/// [`esp-idf-ws2812-rmt`](https://github.com/datenkollektiv/rustyfarian-ws2812)'s `WS2812RMT`.
///

//! ESP32-C6 Meteor / Comet Example (esp-hal, bare-metal)
//!
//! Runs a [`MeteorEffect`] on a 12-LED WS2812B ring — an amber comet with an
//! exponentially-decaying tail, travelling clockwise using the ESP32-C6
...
//!
//! ```sh
//! just build-example hal-ws2812 hal_c6_meteor
//! ```
//!
//! ## Flash
//!
//! ```sh
//! just flash hal_c6_meteor
//! ```

//! ESP32-C6 Twinkle / Sparkle Example (esp-hal, bare-metal)
//!
...
//! ESP32-C6 RMT peripheral on GPIO18.
//!
//! ## Components
//!
...
//!
//! ```sh
//! just build-example hal-ws2812 hal_c6_twinkle
//! ```
//!
//! ## Flash
//!
//! ```sh
//! just flash hal_c6_twinkle
//! ```

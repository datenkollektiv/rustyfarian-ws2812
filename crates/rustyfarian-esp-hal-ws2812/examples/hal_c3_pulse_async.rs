//! ESP32-C3 Async Pulse Example (esp-hal + Embassy, bare-metal)
//!
...
//!
//! See also `hal_c6_pulse_async.rs` and `hal_esp32_pulse_async.rs`.
//!
//! ## Components
//!
...
//!
//! ```sh
//! just build-example hal-ws2812 hal_c3_pulse_async
//! ```
//!
//! ## Flash
//!
//! ```sh
//! just flash hal_c3_pulse_async
//! ```

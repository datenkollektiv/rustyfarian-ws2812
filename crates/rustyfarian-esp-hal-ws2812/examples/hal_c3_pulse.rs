//! ESP32-C3 Blue Pulse Example
//!
//! Runs a [`PulseEffect`] (blue) from `ferriswheel` on a 12-LED WS2812B ring
//! using the ESP32-C3 RMT peripheral on GPIO4.
//!
//! See also `hal_c6_pulse.rs` and `hal_esp32_pulse.rs`.
//!
//! ## Components
//!
...
//!
//! ```sh
//! just build-example hal-ws2812 hal_c3_pulse
//! ```
//!
//! ## Flash
//!
//! ```sh
//! just flash hal_c3_pulse
//! ```

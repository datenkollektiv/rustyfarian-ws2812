...
| [`esp-idf-ws2812-rmt`](crates/esp-idf-ws2812-rmt) | WS2812 driver using ESP-IDF RMT peripheral                  | ESP-IDF (std)       |
| [`esp-hal-ws2812-rmt`](crates/esp-hal-ws2812-rmt) | WS2812 driver using esp-hal RMT peripheral (skeleton)       | esp-hal (no_std)    |
...
```toml
[dependencies]
esp-idf-ws2812-rmt = { git = "https://github.com/datenkollektiv/rustyfarian-ws2812" }
```
